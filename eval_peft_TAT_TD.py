...
def load_peft_model_from_hub(peft_model_id):
    ...
    model = PeftModel.from_pretrained(model, peft_model_id, token="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") 
...
def experiment(peft_model_id, input_arg, model, processor, data_collator, repo_name, data_train, data_test, time):
    ...
    if not input_arg.get("only_eval", False):
        ...
        try:
            model.push_to_hub(peft_model_id, use_auth_token='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')
        except:
...
def main(arg=None):
    ...
    # input_arg["custom_set_test"] = "/work/hungyi2022/TAT-TD-data/TD_1000_test.csv"
    ...
    # repo_name = f"/work/hungyi2022/peft/{input_arg['model_config']}-TD-1000"
    # repo_name = f"/work/hungyi2022/peft/{input_arg['model_config']}-TAT"
