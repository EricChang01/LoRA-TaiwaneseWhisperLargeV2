...
def experiment(peft_model_id, input_arg, model, processor, data_collator, repo_name, data_train, data_test, time):
    ################
    #     Train    #
    ################
    ...
    # Push to Hub    
    # peft_model_id = "cathyi/" + f"tw-zh2.6-{input_arg['model_config']}-Lora".replace("/", "-")
    ...
    if not input_arg.get("only_eval", False):
        ...
        try:
            model.push_to_hub(peft_model_id, use_auth_token='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')
        except:
    ...
    nlp2.write_csv(pred_results, f'pred_{time}_{peft_model_id.replace("/", "-")}.csv')
...
def main(arg=None):
    ...
    input_arg["custom_set_train"] = "/work/hungyi2022/peft/TAT-data/taiwen/TAT-train.csv"
    # input_arg["custom_set_train"] = "/work/hungyi2022/taiwanese-meta/taiwanese-meta-2sec-train.csv"
    # input_arg["custom_set_test"] = "./TAT-data/taiwen/TAT-Vol1-eval.csv"
    # input_arg["custom_set_test"] = "./TAT-data/taiwen/TAT-eval.csv"
    # input_arg["custom_set_test"] = "/work/hungyi2022/taiwanese-meta/taiwanese-meta-2.6sec-test.csv"
    input_arg["custom_set_test"] = "/work/hungyi2022/peft/TAT-data/taiwen/TAT-test.csv"
    # input_arg["custom_set_test"] = "/work/hungyi2022/taiwanese-meta/taiwanese-meta-2sec-eval.csv"
    ...
    # repo_name = f"/work/hungyi2022/peft/{input_arg['model_config']}-TW-meta"
    repo_name = "/work/hungyi2022/Taiwanese-Whisper/openai/whisper-large-v2-taiwen-TAT"
    ...
    models = [
        "cathyi/tw-zh2.6-openai-whisper-large-v2-Lora-epoch1-total5epoch",
        "cathyi/tw-zh2.6-openai-whisper-large-v2-Lora-epoch2-total5epoch",
        "cathyi/tw-zh2.6-openai-whisper-large-v2-Lora-epoch3-total5epoch",
        "cathyi/tw-zh2.6-openai-whisper-large-v2-Lora-epoch4-total5epoch",
        "cathyi/tw-zh2.6-openai-whisper-large-v2-Lora-epoch5-total5epoch",
    ]
    for peft_model_id in models:
        model = experiment(peft_model_id, input_arg, model, processor, data_collator, repo_name, data_train, data_test, time)
